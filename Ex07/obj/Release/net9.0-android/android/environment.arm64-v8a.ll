...
@aot_dso_cache = dso_local local_unnamed_addr global [756 x %struct.DSOCacheEntry] [
	%struct.DSOCacheEntry {
		i64 u0x000bce2feb7ab167, ; from name: libaot-Ex07.dll.so
		i64 u0x000bce2feb7ab167, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Ex07.dll.so
		ptr null; void* handle
	}, ; 0
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x0b6716e4d4d48e49, ; from name: libaot-Ex07.so
		i64 u0x000bce2feb7ab167, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Ex07.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x0b9353270f541ba1, ; from name: Ex07.dll.so
		i64 u0x000bce2feb7ab167, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Ex07.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x184b2169005aed74, ; from name: Ex07.so
		i64 u0x000bce2feb7ab167, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Ex07.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x410c55942685e873, ; from name: aot-Ex07.so
		i64 u0x000bce2feb7ab167, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Ex07.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x4ed0f89bc4729be2, ; from name: aot-Ex07
		i64 u0x000bce2feb7ab167, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Ex07.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xadb12948b51ef503, ; from name: aot-Ex07.dll.so
		i64 u0x000bce2feb7ab167, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Ex07.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xb084f9fd7a8bf665, ; from name: Ex07
		i64 u0x000bce2feb7ab167, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Ex07.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xe97ca163eb3d0331, ; from name: libaot-Ex07
		i64 u0x000bce2feb7ab167, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Ex07.dll.so
		ptr null; void* handle
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [24 x i8] c"com.jotacorp.superlista\00", align 1
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [19 x i8] c"libaot-Ex07.dll.so\00", align 1
